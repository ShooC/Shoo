...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝`, 'red'))
	...
	console.log(color('======================', 'fuchsia'),color('\nSlime Bot', 'pink'),color('\nYahaha bot nya udh berjalan', 'yellow'),color('\n======================', 'fuchsia'))
    store.bind(naimi.ev)
...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: 'Welcomee'}, type: 1}
]
let buttonMessage = {
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://chat.whatsapp.com/ItxvycUljN7Gyk2qnYV9jO`,
mediaUrl: `https://chat.whatsapp.com/ItxvycUljN7Gyk2qnYV9jO`
}}
}
...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: 'Papayy'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./karuta/karuta.xlsx'),
mimetype: docs,
