...
➸ ${reason ? 'Alasan :' + reason : 'Alasan : Tidak Ada'}
...
karutamd = fs.readFileSync('./karuta/karuta.png')
let txtit = anuuh
naimi.sendMessage(from, { caption: anuuh, image: Imgnah, templateButtons: btn886, footer: `Slime Bot By Sho`, mentions: [sender] })
...
const patri = {
text: `⛱️ Silahkan pilih salah satu di bawah`,
footer: `Slime Bot By Sho`,
buttons: buttonstod,
headerType: 1
}
...
break
  case 'afk': {
if (!m.isGroup) return reply('Cuma bisa di grub kak')
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
let user = global.db.users[m.sender]
...
{ buttonId: 'jodohku', buttonText: { displayText: 'Jodohku' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, jawab, ` Slime Bot By Sho`, m, {mentions: ments})
}
break
case '͏͏jodohku͏͏': {
  if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
{ buttonId: 'jadian', buttonText: { displayText: 'Jodohku' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, jawab, ` Slime Bot By Sho`, m, {mentions: menst})
}
break
case 'join': {
if (!isOwner) return reply(mess.owner)
...
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, `Mode Group`, ` Slime Bot By Sho`, m)
...
{ buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, `Mode Edit Info`, ` Slime Bot By Sho`, m)
...
quickReplyButton: {
 ...
 naimi.send5ButImg(i, txt, ` Slime Bot By Sho`, karutamd, btn)
    }
...
naimi.sendListMsg(m.chat, `Pilih salah satu mode menu di bawah`, `Slime Bot By Sho`, '*CHANGE MENU*', `Click Here`, sections, m)
}
break
...
quickReplyButton: {
 ...
 karutamd = fs.readFileSync('./karuta/karuta.jpg')
 let txt = `「 Broadcast Bot 」\n\n${text}`
 naimi.send5ButImg(yoi, txt, ` Slime Bot By Sho`, karutamd, btn)
}
...
naimi.sendMessage(m.chat, { image: { url: anu }, caption: `*© Powered by slime bot*\n\nJangan lupa donet yaa` }, { quoted: m })
 }
break
case '3dbox':
  if (!isPremium) return sendButMessage (from, prem1, prem2, prem3, { quoted:ftex})
...
maker.textpro("https://textpro.me/3d-box-text-effect-online-880.html", [
    `${q}`,])
.then((data) => naimi.sendMessage(m.chat, { image: { url: data }, caption: `*© Powered by slime bot*\n\nJangan lupa donet yaa` }, { quoted: m }))
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
if(!q) return reply(`Penggunaan ${prefix + command} Sho|Md`)
reply(mess.wait)
teks1 = q.split("|")[0]
teks2 = q.split("|")[1]
...
let { toAudio } = require('./lib/converter')
let audio = await toAudio(media, 'mp4')
naimi.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${` Slime Bot By Sho`}.mp3`}, { quoted : m })
}
confirmlimit(sender, 1)
break
...
for (let i of search.all) {
    teks += `ᥫ᭡ No : ${no++}\nᥫ᭡ Type : ${i.type}\nᥫ᭡ Video ID : ${i.videoId}\nᥫ᭡ Title : ${i.title}\nᥫ᭡ Views : ${i.views}\nᥫ᭡ Duration : ${i.timestamp}\nᥫ᭡ Upload At : ${i.ago}\nᥫ᭡ Author : ${i.author.name}\nᥫ᭡ Url : ${i.url}\n\n─────────────────\n\n`
}
...
for (let g of res) {
teks += `ᥫ᭡ *Title* : ${g.title}\n`
teks += `ᥫ᭡ *Description* : ${g.snippet}\n`
teks += `ᥫ᭡ *Link* : ${g.link}\n\n=====================\n\n`
} 
reply(teks)
})
...
ᥫ᭡ Ext : Search
ᥫ᭡ ID : ${anu.videoId}
ᥫ᭡ Duration : ${anu.timestamp}
ᥫ᭡ Viewers : ${anu.views}
ᥫ᭡ Upload At : ${anu.ago}
ᥫ᭡ Author : ${anu.author.name}
ᥫ᭡ Channel : ${anu.author.url}
ᥫ᭡ Url : ${anu.url}`,
    footer: ` Slime Bot By Sho`,
    buttons: buttons,
    headerType: 4
...
naimi.sendMessage(from, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, templateButtons: bton, footer: `Slime Bot By Sho`, mentions: [sender] })
confirmlimit(sender, 1)
})
}
break
...
karutachi = pinnya
let txt99 = `Result : ${q}`
naimi.send5ButImg(from, txt99, `Slime Bot By Sho`, karutachi, btn99)
confirmlimit(sender, 1)
break
case 'couple': {
 if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
...
let buttonMessage = {
    ...
    caption: `ᥫ᭡ Title : ${result.title}\nᥫ᭡ Category : ${result.type}\nᥫ᭡ Detail : ${result.source}\nᥫ᭡ Media Url : ${result.image[2] || result.image[1] || result.image[0]}`,
    footer: ` Slime Bot By Sho`,
    buttons: buttons,
    headerType: 4
}
...
let buttonMessage = {
    ...
    caption: `ᥫ᭡ Title : ${result.title}\nᥫ᭡ Source : ${result.source}\nᥫ᭡ Media Url : ${result.image}`,
    footer: ` Slime Bot By Sho`,
    buttons: buttons,
    headerType: 4
}
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Mimpi :* ${anu.message.mimpi}\nᥫ᭡ *Arti :* ${anu.message.arti}\nᥫ᭡ *Solusi :* ${anu.message.solusi}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama Anda :* ${anu.message.nama_anda.nama}\nᥫ᭡ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\nᥫ᭡ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\nᥫ᭡ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\nᥫ᭡ *Hasil :* ${anu.message.result}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama Suami :* ${anu.message.suami.nama}\nᥫ᭡ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\nᥫ᭡ *Nama Istri :* ${anu.message.istri.nama}\nᥫ᭡ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\nᥫ᭡ *Hasil :* ${anu.message.result}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama Anda :* ${anu.message.nama_anda.nama}\nᥫ᭡ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\nᥫ᭡ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\nᥫ᭡ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\nᥫ᭡ *Sisi Positif :* ${anu.message.sisi_positif}\nᥫ᭡ *Sisi Negatif :* ${anu.message.sisi_negatif}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
case 'artinama': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama :* ${anu.message.nama}\nᥫ᭡ *Arti :* ${anu.message.arti}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama :* ${anu.message.nama}\nᥫ᭡ *Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Life Path :* ${anu.message.life_path}\nᥫ᭡ *Destiny :* ${anu.message.destiny}\nᥫ᭡ *Destiny Desire :* ${anu.message.destiny_desire}\nᥫ᭡ *Personality :* ${anu.message.personality}\nᥫ᭡ *Persentase :* ${anu.message.persentase_kecocokan}`, m)
}
confirmlimit(sender, 1)
break
case 'ship':
...
if (anu.status == false) return reply(anu.message)
naimi.sendImage(m.chat,  anu.message.gambar, `ᥫ᭡ *Nama Anda :* ${anu.message.nama_anda}\nᥫ᭡ *Nama Pasangan :* ${anu.message.nama_pasangan}\nᥫ᭡ *Sisi Positif :* ${anu.message.sisi_positif}\nᥫ᭡ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Tanggal Pernikahan :* ${anu.message.tanggal}\nᥫ᭡ *karakteristik :* ${anu.message.karakteristik}`, m)
}
confirmlimit(sender, 1)
break
case 'sifatusaha': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Lahir :* ${anu.message.hari_lahir}\nᥫ᭡ *Usaha :* ${anu.message.usaha}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Lahir :* ${anu.message.hari_lahir}\nᥫ᭡ *Pekerjaan :* ${anu.message.pekerjaan}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Analisa :* ${anu.message.analisa}\nᥫ᭡ *Angka Akar :* ${anu.message.angka_akar}\nᥫ᭡ *Sifat :* ${anu.message.sifat}\nᥫ᭡ *Elemen :* ${anu.message.elemen}\nᥫ᭡ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendImage(m.chat, anu.message.image, `ᥫ᭡ *Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Simbol Tarot :* ${anu.message.simbol_tarot}\nᥫ᭡ *Arti :* ${anu.message.arti}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
case 'fengshui': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama :* ${anu.message.nama}\nᥫ᭡ *Lahir :* ${anu.message.tahun_lahir}\nᥫ᭡ *Gender :* ${anu.message.jenis_kelamin}\nᥫ᭡ *Angka Kua :* ${anu.message.angka_kua}\nᥫ᭡ *Kelompok :* ${anu.message.kelompok}\nᥫ᭡ *Karakter :* ${anu.message.karakter}\nᥫ᭡ *Sektor Baik :* ${anu.message.sektor_baik}\nᥫ᭡ *Sektor Buruk :* ${anu.message.sektor_buruk}`, m)
}
confirmlimit(sender, 1)
break
case 'haribaik': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Kala Tinantang :* ${anu.message.kala_tinantang}\nᥫ᭡ *Info :* ${anu.message.info}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Hari Lahir :* ${anu.message.hari_lahir}\nᥫ᭡ *Tanggal Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Hari Naas :* ${anu.message.hari_naas}\nᥫ᭡ *Info :* ${anu.message.catatan}\nᥫ᭡ *Catatan :* ${anu.message.info}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Hari Lahir :* ${anu.message.hari_lahir}\nᥫ᭡ *Tanggal Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Arah Naga Hari :* ${anu.message.arah_naga_hari}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Hari Lahir :* ${anu.message.hari_lahir}\nᥫ᭡ *tanggal Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Arah Rezeki :* ${anu.message.arah_rejeki}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
case 'peruntungan': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama :* ${anu.message.nama}\nᥫ᭡ *Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Peruntungan Tahun :* ${anu.message.peruntungan_tahun}\nᥫ᭡ *Hasil :* ${anu.message.result}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Tanggal :* ${anu.message.tanggal}\nᥫ᭡ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\nᥫ᭡ *Watak Hari :* ${anu.message.watak_hari}\nᥫ᭡ *Naga Hari :* ${anu.message.naga_hari}\nᥫ᭡ *Jam Baik :* ${anu.message.jam_baik}\nᥫ᭡ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Nama :* ${anu.message.nama}\nᥫ᭡ *Lahir :* ${anu.message.tgl_lahir}\nᥫ᭡ *Garis Hidup :* ${anu.message.garis_hidup}`, m)
}
confirmlimit(sender, 1)
break
case 'keberuntungan': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Tanggal :* ${anu.message.tgl_memancing}\nᥫ᭡ *Hasil :* ${anu.message.result}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
case 'masasubur': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Hasil :* ${anu.message.result}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Zodiak :* ${anu.message.zodiak}\nᥫ᭡ *Nomor :* ${anu.message.nomor_keberuntungan}\nᥫ᭡ *Aroma :* ${anu.message.aroma_keberuntungan}\nᥫ᭡ *Planet :* ${anu.message.planet_yang_mengitari}\nᥫ᭡ *Bunga :* ${anu.message.bunga_keberuntungan}\nᥫ᭡ *Warna :* ${anu.message.warna_keberuntungan}\nᥫ᭡ *Batu :* ${anu.message.batu_keberuntungan}\nᥫ᭡ *Elemen :* ${anu.message.elemen_keberuntungan}\nᥫ᭡ *Pasangan Zodiak :* ${anu.message.pasangan_zodiak}\nᥫ᭡ *Catatan :* ${anu.message.catatan}`, m)
}
confirmlimit(sender, 1)
break
case 'shio': {
...
if (anu.status == false) return reply(anu.message)
naimi.sendText(m.chat, `ᥫ᭡ *Hasil :* ${anu.message}`, m)
}
...
reply(`ᥫ᭡ _*Title :*_ ${cerpe.title}\nᥫ᭡ _*Author :*_ ${cerpe.author}\nᥫ᭡ _*Category :*_ ${cerpe.kategori}\nᥫ᭡ _*Pass Moderation :*_ ${cerpe.lolos}\nᥫ᭡ _*Story :*_\n${cerpe.cerita}`)
break
...
naimi.sendMessage(m.chat, { image: { url }, caption: `ᥫ᭡ Title : ${anu.title}\nᥫ᭡ Author : ${anu.author.name}\nᥫ᭡ Like : ${anu.like}\nᥫ᭡ Caption : ${anu.caption}` }, { quoted: m })
})
}
}
break
...
await naimi.sendButtonText(m.chat, buttons, '_Kamu tidak sedang berada di anonymous chat_', `Slime Bot By Sho`)
    return false
}
...
await naimi.sendButtonText(m.chat, buttons, `_Kamu masih berada di dalam anonymous chat, menunggu partner_`, ` Slime Bot By Sho`, m)
 return false
}
...
{ buttonId: 'keluar', buttonText: { displayText: 'Stop' }, type: 1 }
    ...
    await naimi.sendButtonText(room.a, buttons, `_Partner ditemukan!_`, ` Slime Bot By Sho`, m)
    room.b = m.sender
    room.state = 'CHATTING'
    await naimi.sendButtonText(room.b, buttons, `_Partner ditemukan!_`, ` Slime Bot By Sho`, m)
} else {
    let id = + new Date
    this.anonymous[id] = {
id,
...
{ buttonId: 'keluar', buttonText: { displayText: 'Stop' }, type: 1 }
    ...
    await naimi.sendButtonText(m.chat, buttons, '_Menunggu partner..._', `Slime Bot By Sho`, m)
}
break
}
...
naimi.sendMessage(from, { caption: menulist, image: global.thumb, templateButtons: bton, footer:`Slime Bot By Sho`, mentions: [sender] })
} else if (setbot.templateGif) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, gifPlayback: true, templateButtons: bton, footer: `Slime Bot By Sho`, mentions: [sender] })
} else if (setbot.templateVid) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `Slime Bot By Sho`, mentions: [sender] })
} else if (setbot.templateVideo) {
naimi.sendMessage(from, { caption: menulist, video: global.vidmenu, templateButtons: bton, footer: `Slime Bot By Sho`, mentions: [sender] })
} else if (setbot.templateMsg) {
naimi.sendMessage(from, { text: menulist, templateButtons: buttonsDefault, footer: `Slime Bot By Sho`, mentions: [sender] })
...
naimi.sendMessage(m.chat, { caption: menulist, document: fs.readFileSync('./karuta/karuta.xlsx'), mimetype: `${docs}`, jpegThumbnail:fs.readFileSync("./karuta/menu.png"), fileName: `${setting.botName}`, templateButtons: buttonmenu, footer: `Slime Bot By Sho`, mentionedJid: [m.sender] })
}
setTimeout( () => {
 naimi.sendMessage(from, { react: { text: `⛱️`, key: m.key }})
}, 3000)
break
default:
